...
const moduleClass = "Introduction to TypeScript";
const classInstructor = "Stephany Nusch";
const classInstructorURL = "https://github.com/stebsnusch";
const classTopic = "Introduction to TypeScript";
var classActivityList = [
  "Examples of TypeScript Advantages",
  "Creating the index.ts file and running the parcel command",
  "Writing the \'sum\' function with TypeScript",
  "How interfaces work",
  "How types work",
  "Treating a \'tag\' input",
  "What are \'generic\' types",
  "Developing conditionals from parameters",
  "Using the \'?\' character for optional values",
  "Creating variables with readonly and private properties",
  "Importing libraries with TypeScript",
  "Using Omit\'s\'example and conclusion",
];
...
function loadFunc() {
  ...
  var mainCssDivText =
    "display: flex; justify-content: space-between; align-items: center; overflow: hidden; width: 5em; height: 5em; border: 0.25em solid rgba(192,208,22,1); border-radius: 3em; ";
  ...
  PS.page.getElementById("mainImgDiv").appendChild(imgTag).style.cssText +=
    cssImgText;

  // Main -> Activity -> Create BankAccount class

  class BankAccount {
    constructor(branch, number, type, balance) {
      this.branch;
      this.number;
      this.type;
      this._balance;
    ...
    withdrawal(value) {
      if (value > this._balance) {
        return "Denied! Please, check your balance...";
      }
  ...
  class CheckingAccount extends BankAccount{
    constructor(branch, number, balance, creditCard) {
      super(branch, number, balance);
      this.type = "checking";
      this._creditCard = this.creditCard;
    }
    get creditCard() {
      return this._creditCard;
    }
    set creditCard(bool) {
      this._creditCard = bool;
    }
  }
  class SavingsAccount extends BankAccount {
    constructor(branch, number, balance) {
      super(branch, number, balance);
      this.type = "savings";
    }
  }
  class CollegeAccount extends BankAccount {
    ...
    withdrawal(value) {
      if (value > 500) {
        return "Denied! Please, check requirements...";
      }
      this._balance = this._balance - value;
      return this._balance;
    }
